...
export default function AdminTicketCard({
  ...
  return (
    <div
      ...
      className="group relative overflow-hidden bg-white dark:bg-[#111111] border border-gray-200 dark:border-white/5 rounded-[2rem] p-4 shadow-sm hover:shadow-2xl transition-all duration-500 h-[540px] flex flex-col cursor-pointer"
    >
      {thumbnails.length > 0 && (
        <BackgroundCarousel
          images={thumbnails}
      ...
      <div className="relative z-10 flex flex-col h-full">
        <div
          ...
          className="w-full h-40 rounded-2xl overflow-hidden border-2 border-transparent group-hover:border-blue-500/30 transition-all shadow-xl mb-3 bg-gray-100 dark:bg-black/20 cursor-alias z-20 shrink-0"
        >
          {thumbnails.length > 0 ? (
            <CarouselThumbnail
              images={thumbnails}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 px-1">
              <div className="flex items-center justify-between gap-2">
                ...
                <div
                  className={`flex flex-col items-center justify-center min-w-[42px] h-[42px] rounded-xl border px-1 transition-all shrink-0 ${ticket.deadline ? "bg-red-500/10 border-red-500/20 shadow-lg" : "bg-gray-100/70 border-gray-200/60 dark:bg-white/5 dark:border-white/10 opacity-60 dark:opacity-30"}`}
                >
                  <span
